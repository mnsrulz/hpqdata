...
columns_to_keep = ['RECEIVED_DATE', 'CASE_STATUS', 'EMPLOYER_NAME', 'CASE_NUMBER', 'WORKSITE_POSTAL_CODE', 'SOC_TITLE', 'JOB_TITLE', 'PREVAILING_WAGE', 'PW_UNIT_OF_PAY', 'WORKSITE_STATE', 'WAGE_RATE_OF_PAY_FROM', 'WAGE_RATE_OF_PAY_TO', 'WAGE_UNIT_OF_PAY']
